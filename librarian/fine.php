...
<body>
    ...
    <div class="container">
    <div class="srch">
        <!--enter username and book ID to change payment status-->
        <h5>Enter username and book ID to change payment status</h5>
    ...
    <h2 style="font-size: medium; font-family:'Times New Roman', Times, serif">Fine Information Of Returned Books</h2>
    <?php
