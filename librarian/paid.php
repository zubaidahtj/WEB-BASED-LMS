...
<div class="container">
    ...
    <div class="srch"><br><br>
        <form action="" method="post">
            <input type="text" name="status" class="form-control" placeholder="Enter Paid" required=""><br>
            <button class="btn btn-default" name="submit" type="submit">Paid</button><br>
        </form>
        <br>
        <p>Please set paid status</p>
    </div>
</div>
</div>
...
{
  mysqli_query($db,"UPDATE  `fine` SET  `status` =  '$_POST[status]' WHERE username='$_SESSION[name]' and book_id='$_SESSION[book_id]';");
