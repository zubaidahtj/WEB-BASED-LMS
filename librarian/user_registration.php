...
<body>
    <section>
        <div class="user_reg_img">
            ...
            <div class="box2">
                ...
                <h1 style="text-align: center; font-size: medium;">Librarian Registration Form</h1>
                <form action="" name="Registration" method="post"> 
                    ...
                    <div class="login">
                        ...
                        <input class= "btn btn-default" type="submit" name="submit" value="Sign Up" style="color: black; width: auto; height:auto"> 
                    </div>     
    ...
    if(isset($_POST['submit']))
    {
        ...
        if($count==0)
        {mysqli_query($db,"INSERT INTO `LIBRARIAN` VALUES('$_POST[first]', '$_POST[last]', '$_POST[username]', '$_POST[password]', 
