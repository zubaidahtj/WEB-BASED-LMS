...
<div class="container">   
    <div class="srch">
    <h5>Enter username and book ID to approve reservation request</h5>
    ...
    <h4 style="text-align: center;">Request for Book Reservation</h4>
<?php
if(isset($_SESSION['login_user']))
{
    $sql= "SELECT member.username, books.book_id,title,author,status FROM member INNER JOIN issue_book ON member.username=issue_book.username 
    INNER JOIN books ON issue_book.book_id=books.book_id WHERE issue_book.approve_status=''";
...
else
{
    ?>
    <br>
    <h5 style="text-align: center;">Please login to view book reservation request</h5>
    <script type="text/javascript">
        alert("Please login to view book reservation request");
    </script>
    <?php
}
