  ...
  <div class="container">
    ...
    $c=0;
      ...
      if(isset($_SESSION['login_user']))
      {
        ...
        ON member.username=issue_book.username inner join books ON issue_book.book_id=books.book_id WHERE 
        issue_book.username ='$_SESSION[login_user]' AND issue_book.approve_status !=' ' 
