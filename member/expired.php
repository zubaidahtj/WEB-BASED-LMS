  ...
  <div class="container">
    ...
    <?php
        ...
        if (isset($_POST['submit2'])) 
        {
            ...
            AND issue_book.username='$_SESSION[login_user]' ORDER BY `issue_book`.`return_date` DESC";
        ...
        else 
        {
            ...
            AND issue_book.approve_status !='Approved' AND issue_book.username='$_SESSION[login_user]' ORDER BY `issue_book`.`return_date` DESC";
            $res=mysqli_query($db,$sql);
        }
