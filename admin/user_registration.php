...
<body>
    <section>
        <div class="user_reg_img">
            ...
            <div class="box2">
                ...
                <h1 style="text-align: center; font-size: medium;">Admin Registration Form</h1>
    ...
    <!-- validate password using JavaScript-->
...
<!-- add admin information to the database after complete registration-->
    <?php
